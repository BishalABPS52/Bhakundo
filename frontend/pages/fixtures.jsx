...
import FixturesPL from '../components/pl/FixturesPL';
...
export default function Fixtures() {
  ...
  return (
    <>
      <Head>
        <title>Fixtures & Results - Bhakundo</title>
        <meta name="description" content="Premier League fixtures and results" />
      </Head>
            ...
            <div className="flex items-center justify-between h-24">
              ...
              <div className="hidden md:flex items-center space-x-2">
                {navItems.map((item) => {
                  ...
                  const isActive = item.id === 'fixtures';
                  return (
      ...
      <div className="px-6 md:px-12 pt-8 pb-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className={`text-4xl font-bold ${textPrimary} mb-2`}>Fixtures & Results</h1>
