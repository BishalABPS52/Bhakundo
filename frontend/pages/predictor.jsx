...
import PredictorPL from '../components/pl/PredictorPL';
...
export default function Predictor() {
  ...
  return (
    <>
      <Head>
        <title>Bhakundo Predictor - Match Predictions</title>
        <meta name="description" content="AI-powered Premier League match predictions" />
      </Head>
            ...
            <div className="flex items-center justify-between h-24">
              ...
              <div className="hidden md:flex items-center space-x-2">
                {navItems.map((item) => {
                  ...
                  const isActive = item.id === 'predictor';
                  return (
